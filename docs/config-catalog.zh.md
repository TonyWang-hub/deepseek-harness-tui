...
来源：[`packages/tui/runtime/src/index.ts:97`](../packages/tui/runtime/src/index.ts)
...
- `@deepseek-ai/dsh-tui-app` — 需要 `tuiRuntime`（[`packages/bundle/tui-app/src/index.ts`](../packages/bundle/tui-app/src/index.ts)）
