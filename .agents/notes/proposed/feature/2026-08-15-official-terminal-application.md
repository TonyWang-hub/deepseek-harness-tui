...
- A performance gate runs on a regenerated benchmark corpus (a scripted long session of at least 100k events; the historical 196k-event corpus was never committed): keystroke echo ≤20ms median, prompt-ready within a stated budget, and RSS bounded across the run by tail rebase.
